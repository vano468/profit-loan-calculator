...
ActiveRecord::Schema.define(version: 20170524095413) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["borrower_id", "month"], name: "index_payments_on_borrower_id_and_month", unique: true
    t.index ["borrower_id"], name: "index_payments_on_borrower_id"
  end

  add_foreign_key "payments", "borrowers"
end
